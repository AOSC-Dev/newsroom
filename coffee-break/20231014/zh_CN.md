...
![龙架构设备上使用 AMD Polaris 设备存在高负载情况下稳定性欠佳，我社成员正使用 glmark2 进行压力测试，协同龙芯工程师及我社贡献者测试内核等组件的新变化；目前，我们仍在调查造成此问题的原因及尝试各种潜在的解决方法](/coffee-break/20231014/glmark2-benchmark.jpg)
